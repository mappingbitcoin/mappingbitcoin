...
export default function LoginStep({ onError }: LoginStepProps) {
    ...
    const handleNstartCredential = (credential: string) => {
        ...
        if (credential.startsWith("bunker://")) {
            ...
            loginWithBunker(credential).catch(err => {
                onError(err instanceof Error ? err.message : "Failed to connect with bunker");
    ...
    return (
        ...
        >
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center ${hasExtension ? "bg-purple-500/20" : "bg-gray-500/20"}`}>
                            <svg className={`w-5 h-5 ${hasExtension ? "text-purple-400" : "text-gray-500"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            </svg>
                        </div>
                        <div className="flex-1">
                            <div className={`font-medium ${hasExtension ? "text-white" : "text-gray-500"}`}>Browser Extension</div>
                ...
                {selectedMethod === "nsec" && (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-white">Nsec / Npub Key</span>
                        </div>
                        <input
                            type="password"
                            value={keyInput}
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-xs text-text-light">Connect via QR code or bunker URL</div>
                            </div>
                            <svg className="w-5 h-5 text-text-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                            </svg>
                ...
                {selectedMethod === "bunker" && (
                    ...
                    >
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-medium text-white">Remote Signer</span>
                        </div>
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-xs text-text-light">Use your signer app to scan</div>
                                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1">
                                            <div className="text-sm font-medium text-white">Enter Bunker URL</div>
                                            <div className="text-xs text-text-light">Paste bunker:// connection string</div>
                                        </div>
                                        <svg className="w-4 h-4 text-text-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                        </svg>
            ...
            {/* Create Account option - only show when no method selected */}
            {!selectedMethod && (
                <div className="pt-4 border-t border-border-light">
                    {isCreatingAccount ? (
                        <div className="text-center py-4">
                            ...
                            <p className="text-sm text-white font-medium">Creating your account...</p>
                        ...
                        <>
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-xs text-text-light">Get started with Nostr via nstart.me</div>
                                    </div>
                                    <svg className="w-4 h-4 text-text-light" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <p className="text-xs text-text-light text-center mt-2">
                                Opens in a popup. You&apos;ll be logged in automatically when done.
                            </p>
                        </>
                    )}
                </div>
