                    ...
                    <div className="flex items-end justify-between gap-8 max-md:flex-col max-md:items-start">
                        <div className="flex-1">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-sm transition-colors no-underline"
                            >
                        ...
                        <div className="lg:sticky lg:top-24 h-fit space-y-4">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    {contact?.website && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <a href={contact.website} target="_blank" rel="noreferrer" className="text-accent hover:text-accent-dark no-underline truncate">
                                    ...
                                    {venue.city && (
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-text-light">{deslugify(venue.city)}, {countryLabel}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center gap-2 w-full bg-accent hover:bg-accent-dark text-white py-2.5 rounded-btn font-medium text-sm transition-colors no-underline"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                ...
                                <Link
                                    href={`/map?lat=${venue.lat}&lon=${venue.lon}&zoom=16&venue=${venue.id}`}
                                    className="flex items-center justify-center gap-2 w-full bg-surface hover:bg-surface-light text-white py-2.5 rounded-btn font-medium text-sm transition-colors no-underline border border-border-light"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
